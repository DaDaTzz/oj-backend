...
import com.da.oj.mapper.QuestionMapper;
import com.da.oj.model.dto.question.QuestionQueryRequest;
import com.da.oj.model.entity.Question;
import com.da.oj.model.entity.QuestionFavour;
import com.da.oj.model.entity.QuestionThumb;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question> implements QuestionService {
    ...
    public void validQuestion(Question question, boolean add) {
        ...
        if (StringUtils.isNotBlank(content)) {
            ThrowUtils.throwIf(content.length() > 2000, ErrorCode.PARAMS_ERROR, "内容过长");
        }
    }
